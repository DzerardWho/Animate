...
function createAnimation() {
    ...
    // Layer 2.5
    {
        ...
        vinyl.duration = 2;
    mainTl.fromTo({
        data: {pos: {x: 338.1, y: 219.45}, scale: {x: 1.09991455, y: 1.09991455}, alpha: 0},
        to: {pos: {x: 334, y: 221.2}, scale: {x: 1.09991455, y: 1.09991455}},
        layer: 2,
        start: 74,
        duration: 14
    }, vinyl).to({
        data: {pos: {x: 310.7, y: 231.35}, scale: {x: 1.09991455, y: 1.09991455}},
        duration: 75
    });
    }
