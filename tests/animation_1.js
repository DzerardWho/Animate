...
function init(){
    ...
    let tl = new Timeline(false, 1);
    let _tl = new Timeline(true, 1);
    tl.addLayer();
    tl.addToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: 0.75, y: 0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: 0.69999695, y: 0.69999695}}, 0, 170, 0, 70);
    tl.addToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: -0.75, y: -0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: -0.69999695, y: -0.69999695}}, 0, 170, 0, 50);
    tl.addToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: 0.75, y: -0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: 0.69999695, y: -0.69999695}}, 0, 170, 0, 0);
    tl.addToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: -0.75, y: 0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: -0.69999695, y: 0.69999695}}, 0, 170, 0, 20);
...
function con(){
    ...
    john.addToLayer(hair_2, {pos:{x: -90, y: -100.55}, alpha: 1}, null, 45, 55, 2, 0);
    john.addToLayer(hair_2, {pos:{x: -90, y: -100.55}, alpha: 1}, {pos:{x: -90, y: -100.55}, alpha: 0}, 100, 7, 2, 0);
    
    // Layer 4
    john.addToLayer(hair_3, {pos:{x: -85.15, y: -101.65}, alpha: 0}, {pos:{x: -85.15, y: -101.65}, alpha: 1}, 97, 5, 3, 0);
    john.addToLayer(hair_3, {pos:{x: -85.15, y: -101.65}}, null, 102, 68, 3, 0);

    // Layer 5
    john.addToLayer(face, {pos:{x: -18.55, y: 247.9}}, {pos:{x: 30.9, y: 224}}, 0, 106, 4, 0);
    john.addToLayer(face, {pos:{x: 31.2, y: 223.9}}, {pos:{x: 31.2, y: 223.9}}, 106, 6, 4, 0);
    john.addToLayer(face, {pos:{x: 32.8, y: 223.05}}, {pos:{x: 32.8, y: 223.05}}, 112, 4, 4, 0);
    john.addToLayer(face, {pos:{x: 33.85, y: 222.6}}, null, 116, 1, 4, 0);
    john.addToLayer(face, {pos:{x: 34.05, y: 222.45}}, {pos:{x: 34.8, y: 222.15}}, 117, 3, 4, 0);
    john.addToLayer(face, {pos:{x: 34.8, y: 222.15}}, null, 120, 1, 4, 0);
    john.addToLayer(face, {pos:{x: 35, y: 222}}, {pos:{x: 36.4, y: 221.3}}, 121, 7, 4, 0);
    john.addToLayer(face, {pos:{x: 36.4, y: 221.3}}, null, 128, 1, 4, 0);
    john.addToLayer(face, {pos:{x: 36.6, y: 221.25}}, {pos:{x: 38.15, y: 220.45}}, 129, 8, 4, 0);
    ...
    john.addToLayer(face, {pos:{x: 38.8, y: 220.15}}, {pos:{x: 39.15, y: 220.05}}, 141, 2, 4, 0);
    john.addToLayer(face, {pos:{x: 39.15, y: 220.05}}, null, 143, 1, 4, 0);
    ...
    john.addToLayer(face, {pos:{x: 39.8, y: 219.65}}, {pos:{x: 41.15, y: 219.05}}, 148, 12, 4, 0);
    john.addToLayer(face, {pos:{x: 41.15, y: 219.05}}, null, 160, 1, 4, 0);
