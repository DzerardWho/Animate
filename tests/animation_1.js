...
function init(){
    ...
    tl.addObjectToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: 0.75, y: 0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: 0.69999695, y: 0.69999695}}, 0, 170, 0, 70);
    tl.addObjectToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: -0.75, y: -0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: -0.69999695, y: -0.69999695}}, 0, 170, 0, 50);
    tl.addObjectToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: 0.75, y: -0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: 0.69999695, y: -0.69999695}}, 0, 170, 0, 0);
    tl.addObjectToLayer(john, {pos: {x: 221.2, y: 130.45}, scale: {x: -0.75, y: 0.75}}, {pos: {x: 248.5, y: 28.85}, scale: {x: -0.69999695, y: 0.69999695}}, 0, 170, 0, 20);
    _tl.addObjectToLayer(tl, {pos: {x: 75, y: 90}}, null, 0, 170, 0, 0);
